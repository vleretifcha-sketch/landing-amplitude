    ...
    <section id="services" className="px-4 py-24 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-14 grid gap-5 lg:grid-cols-3">
          {/* Card 1 — Cours signature */}
          <article className="card-dark flex flex-col overflow-hidden p-6 sm:p-8">
          ...
          <article className="card-dark flex flex-col overflow-hidden p-6 sm:p-8">
            <div className="rounded-2xl border border-border bg-black/50 p-4">
              ...
              <div className="mt-4 flex items-end justify-center gap-2 h-28">
        ...
        {/* Bottom wide card */}
        <article className="card-dark mt-5 grid overflow-hidden lg:grid-cols-2">
